 ...
 * `chars` counts the normalised preview string the clip ran on — whitespace
 * collapsed and the `[tool]` / `→ calls` label prepended — so it is the
 * pre-truncation preview length, not the raw message length.
 */
